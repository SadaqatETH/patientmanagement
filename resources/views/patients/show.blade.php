        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Patient Details</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ucfirst($patient->name)}}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">{{ucfirst($patient->name)}}</a>
                                    <!--end::Name-->
                                    <!--begin::Email-->
                                    <a href="#" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">{{$patient->contact_information}}</a>
                                    <!--end::Email-->
                                </div>
                                <!--end::Summary-->
                                ...
                                <div class="pb-5 fs-6">
                                    <!--begin::Patient Detail-->
                                    <div class="fw-bold mt-5">Patient Code</div>
                                    <div class="text-gray-600">{{$patient->code}}</div>
                                    <!--begin::Patient Detail-->
                                    <!--begin::Patient Detail-->
                                    <div class="fw-bold mt-5">Contact Info</div>
                                    <div class="text-gray-600">
                                        <a href="#" class="text-gray-600 text-hover-primary">{{$patient->contact_information}}</a>
                                    </div>
                                    <!--begin::Patient Detail-->
                                    <!--begin::Patient Detail-->
                                    <div class="fw-bold mt-5">History</div>
                                    <div class="text-gray-600">{{ucfirst($patient->medical_history)}}</div>
                                    <!--begin::Patient Detail-->
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                            ...
                                            <tr class="text-start text-muted text-uppercase gs-0">
                                                <th class="min-w-100px">Medicine Title</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15480</a>
                                                </td>
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                        ...
                                        <form class="form" action="#" id="kt_ecommerce_customer_profile">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ucfirst($patient->name)}}" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Row-->
                                            <div class="row row-cols-1 row-cols-md-2">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input type="email" class="form-control form-control-solid" placeholder="" name="gen_email" value="{{$patient->contact_information}}" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                </div>
                                        ...
                                        <div class="py-0">
                                            ...
                                            <div id="kt_ecommerce_customer_addresses_1" class="collapse fs-6 ps-9" data-bs-parent="#kt_ecommerce_customer_addresses">
                                                ...
                                                <div class="d-flex flex-column pb-5">
                                                    <div class="fw-bold text-gray-600">{{ucfirst($patient->name)}}</div>
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-800">**** 4805</td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 5341</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Name</td>
                                                                <td class="text-gray-800">{{ucfirst($patient->name)}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 9497</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                                    ...
                                                    <div class="flex-equal">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Email</td>
                                                                <td class="text-gray-800">
                                                                    <a href="#" class="text-gray-900 text-hover-primary">{{$patient->contact_information}}</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Origin</td>
